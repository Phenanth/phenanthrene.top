...
<div class="index">
	...
	<div class="ft-library" >
		<img width="32px" class="col-md-offset-2 git" onclick="window.open('https://github.com/Phenanth/Library-System');" src="../../../../static/svg/GALogin/github5.svg"/>
	</div>
